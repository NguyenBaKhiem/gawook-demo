  ...
  export default {
    ...
    methods: {
      $_resizeHandler() {
        ...
        if(mainEl) {
            this.maxSlideItems = mainEl.clientWidth < 1000 ? mainEl.clientWidth < 800 ? mainEl.clientWidth < 600 ? 3 : 4 : 5 : 6;
        }
      },
      restartHooper (isOpenBar) {
          setTimeout(() => { 
            ...
            let hooperWidth = gridMainEl.getBoundingClientRect().width - rightBarWidth;
            if(gridMainEl) {
                this.maxSlideItems = hooperWidth < 1000 ? hooperWidth < 800 ? hooperWidth < 600 ? 3 : 4 : 5 : 6;
            }
          }, 501)
      }
    }
