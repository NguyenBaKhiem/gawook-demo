...
Vue.mixin({
  ...
  methods: {
    ...
    isRequiredGoogleAuthenticator () {
      const messageGoogleAuth = window.i18n.t('validation.required', { attribute: window.i18n.t('validation.attributes.google_authenticator_code') });
      return this.errors.has('google_authenticator_code') &&
