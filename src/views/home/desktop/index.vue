            ...
            <div class="grid-main">
              <el-card shadow="never" :body-style="{ padding: '0' }" class="header-wrapp">
                ...
                <div class="wave-wrapp">
                  ...
                  <g class="parallax">
                  <use xlink:href="#gentle-wave" x="50" y="0" fill="rgba(255, 255, 255, 0.48)"></use>
                  <use xlink:href="#gentle-wave" x="50" y="3" fill="rgba(255, 255, 255, 0.78)"></use>
                  <use xlink:href="#gentle-wave" x="50" y="6" fill="rgba(255, 255, 255, 0.8)"></use>
                  </g>
                  </svg>
                </div>
              </el-card>
  ...
  .grid-content {
    ...
    .grid-main {
      ...
      .header-wrapp {
        ...
        height: 235px;
        position: relative;
        background: linear-gradient(45deg, rgba(22, 229, 255, 0.7) 0%, rgba(28, 241, 153, 0.6) 100%);
        .app-detail {
          text-align: center;
